...
import uvicorn
# ⚠️ 注意：确保你的 requirements.txt 里写的是 moviepy==1.0.3
...
# 👇 [关键修改] 直接写死你的 Render 域名，不再依赖环境变量
# 这样保证代码一定能获取到正确的公网前缀
...
async def update_playlist(
    ...
    print(f"DEBUG: ✅ 用户上传图片已保存! 路径: {file_path}, 大小: {file_size/1024:.2f} KB")
